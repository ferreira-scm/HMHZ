...
pdf("/SAN/Susanas_den/HMHZ/results/2020Aug/plots/qualityProfileF1_2_2.pdf",
    height = 7, width = 7)
plotQualityProfile(fastqF[[1]])
dev.off()

pdf("/SAN/Susanas_den/HMHZ/results/2020Aug/plots/qualityProfileR1_2_2.pdf",
    height = 7, width = 7)
plotQualityProfile(fastqR[[1]])
dev.off()

#Creation of a folder for filtrated reads
filt_path <- "/SAN/Susanas_den/HMHZ/results/2020Aug/filtered2_2"
...
if(doMultiAmp){
    ...
    filedir <- "/SAN/Susanas_den/HMHZ/results/2020Aug/stratified_files_2_2"
    ...
    saveRDS(MA, "/SAN/Susanas_den/HMHZ/results/2020Aug/MA2_2.RDS")
} else{
    MA <- readRDS("/SAN/Susanas_den/HMHZ/results/2020Aug/MA2_2.RDS")
}

trackingF=getPipelineSummary(MA)
PipSum=plotPipelineSummary(trackingF)+scale_y_log10() 
ggsave("Sequencing_summary_HMHZ_2_2.pdf", PipSum, path = "/SAN/Susanas_den/HMHZ/results/2020Aug/", height = 15, width = 15)
...
pdf("/SAN/Susanas_den/HMHZ/results/2020Aug/Estimeted_error_ratesF_2_2.pdf",
    height = 7, width = 7)
err_F
dev.off()
err_R <- plotErrors(errR, nominalQ=TRUE)
pdf("/SAN/Susanas_den/HMHZ/results/2020Aug/Estimeted_error_ratesR_2_2.pdf",
    height = 7, width = 7)
err_R
dev.off()
...
pdf("/SAN/Susanas_den/HMHZ/results/2020May/Sequencing_summary_HMHZ_2_2.pdf",
    height = 6, width = 8)
PipSum
dev.off()

Heatmap <- plotAmpliconNumbers(MA)
pdf("/SAN/Susanas_den/HMHZ/results/2020Aug/heat_Sequencing_summary_HMHZ_2_2.pdf",
    height = 15, width = 15)
Heatmap
dev.off()
...
MA <- blastTaxAnnot(MA,
                    ...
                    infasta = "/SAN/Susanas_den/HMHZ/tmp/HMHZ2_2.fasta",
                    outblast = "/SAN/Susanas_den/HMHZ/results/2020Aug/blast2_2_out.fasta",
                    taxonSQL = "/SAN/db/taxonomy/update20200827/accessionTaxa.sql",
                    num_threads = 20)

saveRDS(MA, file="/SAN/Susanas_den/HMHZ/results/2020Aug/MA2_2Tax.Rds") ##Just Test run HMHZ 1

##Start from here after the taxonomic annotation
MA<- readRDS(file= "/SAN/Susanas_den/HMHZ/results/2020Aug/MA2_2Tax.Rds") ###Test run
...
saveRDS(PS, file="/SAN/Susanas_den/HMHZ/results/2020Aug/PhyloSeqCombi_HMHZ_2_2.Rds") ###Results from preliminary analysis (Sample data)
